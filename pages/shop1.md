...
<style>
  ...
  .shop-hero .btn{display:inline-block;padding:.9rem 1.1rem;border-radius:.75rem;background:#111;color:#fff;text-decoration:none;font-weight:700}
  ...
  .btn{display:inline-block;padding:.6rem .9rem;border-radius:.65rem;background:#111;color:#fff;text-decoration:none;font-weight:700}
  ...
  .explore ul{padding-left:1rem}
  .explore li{margin:.4rem 0}
...
<section class="section explore">
  ...
  <ul>
    <li>🖼 <a href="https://moxiecolor.gumroad.com/">
      See all digital downloads on Gumroad</a></li>
    <li>🧵 <a href="https://www.spoonflower.com/profiles/moxiecolor">
      Shop fabrics & wallpaper on Spoonflower</a></li>
    <li>📚 <a href="https://www.amazon.com/dp/B0D8N1T5NQ">
      Puzzle Book on Amazon</a></li>
    <!-- Optional: parked Etsy tile if you want it visible -->
    <!-- <li>🛍 <a href="https://www.etsy.com/shop/moxiecolor">Etsy (coming soon)</a></li> -->
  </ul>
</section>
